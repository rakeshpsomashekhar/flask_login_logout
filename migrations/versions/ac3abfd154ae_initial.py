...
Revision ID: ac3abfd154ae
Revises: 
Create Date: 2024-06-26 13:42:38.388610
...
def upgrade():
    ...
    op.create_table('user_logout_history',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('logout_datetime', sa.DateTime(), nullable=True),
    sa.Column('logout_success', sa.Boolean(), nullable=True),
    sa.Column('error_message', sa.String(length=255), nullable=True),
    sa.Column('ip_address', sa.String(length=45), nullable=True),
    sa.Column('user_agent', sa.String(length=255), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
...
def downgrade():
    ...
    op.drop_table('user_logout_history')
